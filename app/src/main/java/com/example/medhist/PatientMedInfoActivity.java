...
public class PatientMedInfoActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_med_info);
